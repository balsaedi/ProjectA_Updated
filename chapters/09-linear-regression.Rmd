...
3. Generate a summary of the linear regression model, including              relevant statistics, and assign it to a variable named
   `model_summary`. 
   
4. Finally, use the `linear_model` to make predictions for the miles
   per gallon values in the mtcars dataset, and assign the 
   predicted values to a variable named `predicted_mpg`
