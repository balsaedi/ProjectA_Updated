...
## CODE CHALLENGE
1. Create two numeric vectors, `vec1` containing elements 8, 5, 10, 50, 3 and
  `vec2` containing 78, 15, 2, 13, 59. Perform element-wise addition and then
  subtract `vec1` from `vec2`, multiply `vec1` and `vec2`, and divide `vec2` by `vec1`. Store
  the results in new vectors: `addition_vec`, `subtraction_vec`,
  `multiplication_vec` and `division_vec`.
